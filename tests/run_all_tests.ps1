...
$expectedTestCount = 84   # 09-18 +1: test_abyss_exit_button (v2.1.11 어비스 보상 화면 3버튼 - 나가기 글자 위치 클릭) / 09-16 +1: test_dg_card_console_offline (v2.1.10 콘솔 카드 '태되' 조각 재현) / 09-16 +1: test_abyss_chance_toggle_yield (v2.1.10 우연한 만남 켜기 양보·팝업 복구) / 09-15 +1: test_nyan_gold_offline (v2.1.10 골드 앞자리 소실 재현) / 09-15 +1: test_quest_tracker_offline (v2.1.9 타 PC 트래커 상단 잘림 재현) / 09-14 +1: test_nyan_cards_scale_offline (v2.1.9 카드 존 배율 라벨 재현) / 08-20 +1: test_dg_pill_highlight (v2.1.2) / 09-01 +1: test_embedded_host (v2.1.4) / 09-07 +1: test_dg_card_console (v2.1.6) / 09-08 +1: test_yield_batch (v2.1.7) / 09-09 +1: test_life_cycle_deadline (v2.1.8) / 09-09 +1: test_life_scroll_yield (v2.1.8 실기 실측) / 09-10 +1: test_party_find_yield (v2.1.8) / 09-10 +1: test_abyss_detail_back (v2.1.8) / 09-11 +1: test_event_overlay_yield (v2.1.8) / 09-11 +1: test_dg_retry_button_offline (v2.1.8 실사고 - 이진화 폴백) / 09-13 +1: test_life_close_yield (v2.1.9) / 09-13 +2: test_last_run_exit_yield, test_popup_helper_yield (v2.1.9) / 09-13 +1: test_entry_popup_yield (v2.1.9)
