...
Check-Pattern '어비스에서도 커스텀 반복 선택 가능' `
  '\$supportsCustom\s*=\s*\(-not \$isEtc\) -and \(-not \$isHunting\) -and \(\(-not \$isLife\) -or \$isLifeGather\)[\s\S]{0,120}\$rbCustomRepeat\.Enabled\s*=\s*\$supportsCustom'   # 사냥터·생활 가공·기타 제외 (2026-08-15 기타 신설)
