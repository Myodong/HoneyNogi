...
$script:guiMutex = New-Object System.Threading.Mutex($false, 'Global\MabinogiMobileAutomationGui')
...
if (-not $guiMutexAcquired) {
  [System.Windows.Forms.MessageBox]::Show(
    ...
    '마비노기 자동화', [System.Windows.Forms.MessageBoxButtons]::OK,
...
# 모두 반영됩니다. 파일명은 MabinogiAuto.exe 로 고정 - 업데이트는 늘 '덮어쓰기 한 번'.
...
$form.Text = "마비노기 모바일 자동화 컨트롤 패널 v$appVersion"
